/*
 * File: ftk_input_method_chooser.h
 * Author:  He HaiQiang <ngwsx2008@126.com>
 * Brief:   input method chooser.
 *
...
#ifndef FTK_INPUT_METHOD_CHOOSER_H
#define FTK_INPUT_METHOD_CHOOSER_H 
...
#endif/*FTK_INPUT_METHOD_CHOOSER_H*/
